...
cat > /etc/nginx/include_csp.conf <<ENDD
#generated by https://www.cspisawesome.com/content_security_policies
add_header Content-Security-Policy "default-src 'none'; script-src 'self' data: 'unsafe-inline' *.xron.net; object-src 'self' data:; style-src 'self' data: 'unsafe-inline'; img-src 'self' data:; media-src *; frame-src 'self' data:; font-src *; frame-ancestors 'none'";
add_header X-Content-Security-Policy "default-src 'none'; script-src 'self' data: 'unsafe-inline' *.xron.net; object-src 'self' data:; style-src 'self' data: 'unsafe-inline'; img-src 'self' data:; media-src *; frame-src 'self' data:; font-src *; frame-ancestors 'none'";
add_header X-WebKit-CSP "default-src 'none'; script-src 'self' data: 'unsafe-inline' *.xron.net; object-src 'self' data:; style-src 'self' data: 'unsafe-inline'; img-src 'self' data:; media-src *; frame-src 'self' data:; font-src *; frame-ancestors 'none'";
...
#add_header Content-Security-Policy "frame-ancestors 'none'"; #added in csp above
