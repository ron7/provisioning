...
# Add php7.3
if ! grep -E "^deb http://ppa.launchpad.net/ondrej/php/ubuntu bionic main" /etc/apt/sources.list ;then echo "deb http://ppa.launchpad.net/ondrej/php/ubuntu bionic main" >>  /etc/apt/sources.list ;fi
if ! grep -E "^deb-src http://ppa.launchpad.net/ondrej/php/ubuntu bionic main" /etc/apt/sources.list ;then echo "deb-src http://ppa.launchpad.net/ondrej/php/ubuntu bionic main" >>  /etc/apt/sources.list ;fi
